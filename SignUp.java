		...
		if(s.equals("Signup"))
		{
			...
			//System.exit(0);
 				try
					...
					ps=con.prepareStatement("Insert into receptionlist(rid,rname,email,phno,pwd) values(?,?,?,?,?)");
					ps.setInt(1,usid);					
					ps.setString(2,uname);		ps.setString(3,email);
					ps.setBigDecimal(4,new BigDecimal(phno));		ps.setString(5,pwd);
